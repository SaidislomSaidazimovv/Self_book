...
const features = [
  {
    ...
    description:
      "Choose from dozens of professionally designed templates that make your content shine and stand out.",
  ...
  },
  {
    ...
    description:
      "Built with modern technology for blazing fast loading speeds and smooth interactions.",
  ...
  },
  {
    ...
    title: "Global Reach",
    description:
      "Share your story with the world through optimized SEO and social media integration.",
  ...
  },
  {
    ...
    description:
      "Connect with other creators and grow your audience through our vibrant community.",
  ...
  },
  {
    ...
    description:
      "Track your performance with detailed analytics and grow your digital presence.",
  ...
  },
  {
    ...
    description:
      "Build professional websites without writing a single line of code. Drag, drop, and publish.",
  ...
  },
  {
    ...
    description:
      "Every template is fully responsive and looks perfect on all devices and screen sizes.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            digital presence effortlessly. No technical skills required.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            <div
              ...
              style={{
                ...
                transform:
                  index === currentIndex ? "translateY(-8px) scale(1.05)" : "",
              }}
            >
              <div
              ...
              <div className="relative z-10">
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${
                    feature.color
                  } rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg ${
