...
const testimonials = [
  {
    ...
    content:
      "Selfbook transformed how I showcase my artwork. The templates are stunning and the customization options are endless.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    content:
      "Building my professional portfolio has never been easier. The platform is intuitive and the results are impressive.",
    rating: 5,
  },
  {
    ...
    content:
      "I love how easy it is to share my stories and connect with readers. The analytics help me understand my audience better.",
    rating: 5,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of creators who have transformed their digital
            presence with Selfbook.
          </p>
        </div>
